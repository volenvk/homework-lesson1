...
class CinemaSelection : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val options = intent.getParcelableExtra<Options>(EXTRA_OPTIONS) ?: throw IllegalArgumentException("Can't start without options")

        createCinemaList(binding, options.count)
    }

    private fun createCinemaList(binding: ActivityCinemaSelectionBinding, count: Int){
